...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NecessaryDrugs.Core.Entities.Order", b =>
                {
                    ...
                    b.Property<string>("DelivaryAdress")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("QuantitiesListAsString")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("NecessaryDrugs.Core.Entities.OrderItem", b =>
                {
                    b.Property<int>("MedicineId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NecessaryDrugs.Core.Entities.Purchase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NecessaryDrugs.Core.Entities.PurchaseItem", b =>
                {
                    b.Property<int>("MedicineId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("MedicineId", "PurchaseId");
            ...
            modelBuilder.Entity("NecessaryDrugs.Core.Entities.Supplier", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("NecessaryDrugs.Core.Entities.Purchase", b =>
                {
                    b.HasOne("NecessaryDrugs.Core.Entities.Supplier", "Supplier")
                        .WithMany()
            ...
            modelBuilder.Entity("NecessaryDrugs.Core.Entities.PurchaseItem", b =>
                {
                    ...
                    b.HasOne("NecessaryDrugs.Core.Entities.Purchase", "Purchase")
                        .WithMany("PurchasedMedicines")
            ...
            modelBuilder.Entity("NecessaryDrugs.Core.Entities.Supplier", b =>
                {
                    b.HasOne("NecessaryDrugs.Core.Entities.NormalUser", "User")
                        .WithOne("Supplier")
                        .HasForeignKey("NecessaryDrugs.Core.Entities.Supplier", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
